...
сколько версий сверено, сколько уязвимостей найдено, не ответил ли сервис — или что
сверять было нечего. Последнее — обычная ситуация для современных SPA: сборщики
вроде Vite и Next.js выкидывают версии из имён файлов, и определить, какой именно
React или Swiper на странице, из разметки невозможно. Инструмент в таком случае
прямо перечисляет технологии, версию которых не удалось установить, вместо того
чтобы молчать и создавать впечатление, что всё чисто.
